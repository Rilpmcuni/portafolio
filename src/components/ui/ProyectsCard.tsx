...
const ProyectsCard: React.FC<Props> = ({ proyect }) => {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center">
            <div
                className="absolute inset-0 z-0 flex h-96 w-96 items-center justify-center rounded-2xl bg-bg bg-cover bg-center bg-no-repeat grayscale"
                style={{
                    backgroundImage: `url(${proyect.bgCard})`,
                    opacity: "0.5",
                }}
            ></div>
            <div className="relative z-10 flex h-96 w-96 flex-col items-center justify-center rounded-2xl bg-bg/50 bg-cover bg-center bg-no-repeat px-4 text-center">
